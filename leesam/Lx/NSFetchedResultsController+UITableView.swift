 ...
 */
class LxFetcherContainer : NSObject{
...
*/
class LxFetchTableViewDataSource<Entity, TableCell> : NSObject, UITableViewDataSource where Entity: NSManagedObject, TableCell: UITableViewCell{
...
extension NSFetchedResultsController{
    ...
    */
    @objc var lx : LxFetcherContainer{
        get{
            return LxFetcherContainer(self as! NSFetchedResultsController<NSFetchRequestResult>); //
        }
    }
}

extension LxFetcherContainer{
    /**
    ...
    func bindTableView<Entity, TableCell>(to: UITableView, cellIdentifier: String, entityType: Entity.Type, cellType: TableCell.Type
        , cellConfigurator:  @escaping (_ cellPath: IndexPath, _ entity: Entity, _ cell: TableCell) -> Void) -> LxFetchTableViewDataSource<Entity, TableCell> where Entity: NSManagedObject, TableCell: UITableViewCell{
        //LxFetchTableViewDataSource.init
        let value = LxFetchTableViewDataSource.init(self.controller, type: Entity.self, cellType: TableCell.self, cell_id: cellIdentifier, generator: cellConfigurator);
