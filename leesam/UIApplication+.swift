...
extension UIApplication{
    ...
    func openReview(_ appId : String = "1193053041", completion: ((Bool) -> Void)? = nil){
    ...
    func openTwitter(_ id : String, webOpen: ((URL) -> Void)? = nil){
    ...
    /*func openFacebook(_ id : String, webOpen: ((URL) -> Void)? = nil){
